  ...
  <div class="container vh-100">
    ...
    <form action="#">
      <div class="form-group">
        <div class="row my-4">
          <div class="col-6">
            <input type="text" class="form-control" id="employer" placeholder="Employer Name">
          </div>
          <div class="col-6">
            <select type="text" class="form-control" id="job_title">
        ...
        <div class="row my-4">
          <div class="col-6">
            <select type="text" class="form-control" id="work_type">
