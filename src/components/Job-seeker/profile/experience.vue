  ...
  <form @submit.prevent="onSubmit" @reset="onReset">
   <div class="row justify-content-center mt-3">
      ...
      <div  v-if="(i>0)"  class="cross"  style="cursor:pointer;" @click="deleteItem(i)" >x</div>
           <h4 v-if="(i>0)"  class="pl-2">Enter Experience Details {{ i + 1 }}</h4>
          <div class="row">
            
            <div class="col-sm-6">
            <a-input v-decorator="[`employerName`,]"
                        v-model="ticket.employerName"
                     type="text" class="form-control my-2 py-3" id="employerName" placeholder="Employer Name"
                     :class="{ 'is-invalid': v.employerName.$error }"></a-input>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-sm-6">
            ...
            v-model="ticket.city"
                    type="text" class="form-control my-2" id="city"
                     ...
                     <option value="Multan">Lahore</option>
                     <option value="Multan">Islamabad</option>
...
<option value="Pakistan">Pakistan</option>
        ...
        <div class="row">
          <div class="col-md-6">
            <a-textarea v-decorator="[`jobDescription`,]"
              v-model="ticket.jobDescription"
                        ...
                        :class="{ 'is-invalid': v.jobDescription.$error }"></a-textarea>
          </div>
        </div>
    ...
    <hr>
      <div class="row float-right">
           <button class="login-button-style btn btn-light px-5" @click="changed(2)">Go Back</button>
