  ...
  <div class="container vh-100">
    ...
    <form action="#">
      <div class="form-group">
        <div class="row my-4">
          ...
          <div class="col-6">
            <select type="text" class="form-control" id="employer_name">
        ...
        <div class="row my-4">
          <div class="col-6">
            <select type="text" class="form-control" id="client_name">
              <option value="0">Client Name</option>
            </select>
          </div>
          <div class="col-6">
            <select type="text" class="form-control" id="project_status">
    ...
    <div class="row float-right">
      <div class="col-12">
        ...
        <button class="btn btn-primary px-5" @click="changed(5)">Proceed</button>
      </div>
    </div>
  </div>
</template>
