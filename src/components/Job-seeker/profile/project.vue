  ...
  <form @submit.prevent="onSubmit" @reset="onReset">
   <div class="row justify-content-center mt-3">
      ...
      <div  v-if="(i>0)"  class="cross"  style="cursor:pointer;" @click="deleteItem(i)" >x</div>
           <h4 v-if="(i>0)"  class="pl-2">Enter Projects Details {{ i + 1 }}</h4>
          <div class="row">
            
            <div class="col-sm-6">
            <a-input v-decorator="[`projectTitle`,]"
                        v-model="ticket.projectTitle"
                     type="text" class="form-control my-2 py-3" id="projectTitle" placeholder="projectTitle"
                     :class="{ 'is-invalid': v.projectTitle.$error }"></a-input>
          </div>
          <div class="col-sm-6">
            ...
            v-model="ticket.employerName"
              ...
              <a-option value="" disabled selected hidden >Job Title</a-option>
              <option value="jslabs" >jslabs</option>
            </select>
          </div>
          ...
          <div class="col-sm-6">
            ...
            v-model="ticket.clientName"
                    type="text" class="form-control my-2" id="clientName"
          ...
          <div class="col-sm-6">
           ...
           v-model="ticket.projectStatus"
              ...
              <!-- <option value=""  disabled selected hidden>Country</option> -->
               <option value="Pakistan">On going</option>
          ...
          <div class="col-md-6">
            <a-textarea v-decorator="[`projectDetail`,]"
              v-model="ticket.projectDetail"
                        ...
                        :class="{ 'is-invalid': v.projectDetail.$error }"></a-textarea>
          </div>
        </div>
    ...
    <hr>
      <div class="row float-right">
           <button class="login-button-style btn btn-light px-5" @click="changed(3)">Go Back</button>
