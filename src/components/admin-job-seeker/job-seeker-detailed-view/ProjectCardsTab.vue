<template>
  <div>
    <div
      class="display-flex align-item-center mt-30 justify-content-space-berween"
    >
      <div class="">
        <div>
    ...
    <div class="mt-30">
      <div>
        <span class="about-content-title">Project Details</span>
      </div>
