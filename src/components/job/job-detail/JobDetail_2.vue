              ...
              <div class="col-lg-9 text-muted">
                <ul>
                  ...
                  <li>End to end project management: Define project tasks, actively track project progress, and
                    milestones, publish periodic progress reports, recommend actions
                  </li>
            ...
            <div class="row">
              <div class="col-12 unorder_list">
                ...
                <div>
                  <input type="checkbox" checked>
                  <span
                    class="ml-2">Laboris laboris nostrud consect etur magna. Aliqua sint dolore esse ut occaecat do.</span>
                </div>
        ...
        <div class="row">
          <div class="col-12">
            <div style="display: flex">
              <button type="button" class="btn btn-light px-4 mr-2"><img src="../../../assets/share.svg" alt="share"
                                                                         class="mr-2">Share
              </button>
              <button type="button" class="btn btn-light px-4 mr-2"><img src="../../../assets/tweeter.svg" alt="tweeter"
                                                                         class="mr-2">Tweet
              </button>
              <button type="button" class="btn btn-light px-4"><img src="../../../assets/save.svg" alt="save"
                                                                    class="mr-2">Save
              </button>
            </div>
          </div>
