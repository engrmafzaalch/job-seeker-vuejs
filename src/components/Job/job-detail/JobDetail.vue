...
<div class="row">
  <div class="col-md-8 wrapper">
      ...
      <div>
        <img style="float: left; padding: 20px" src="../../../assets/job-detail/google-icon.png" alt="Image"/>
        ...
        <div class="display-flex title_text">
          <p><img src="../../../assets/job-detail/map-pin.svg" class="mr-2"/> Abuja , Nigeria</p>
          <p class="ml-5"><img src="../../../assets/job-detail/clock.svg" class="mr-2"/> 2 Hours Ago</p>
          <p class="ml-5"><img src="../../../assets/job-detail/dollar-sign.svg" class="mr-2"/> 2000 - 6000</p>
        </div>
      </div>
  ...
  <p class="text">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</p>
    ...
    <a style="color: #00C87A" href="Career@gmail.com">Career@gmail.com</a>
      ...
      <div class=" mt-4" style="display: flex">
        <div class="btn_menu"><img src="../../../assets/job-detail/share.svg"/>Share</div>
        <div class="btn_menu ml-3"><img src="../../../assets/job-detail/tweeter.svg"/> Tweet</div>
        <div class="btn_menu ml-3"><img src="../../../assets/job-detail/save.svg"/> Save</div>
      </div>
      <h3 class="description_heading mt-5" style="font-size: 24px">Jobs you might be interested in</h3>

<div class="card mt-4">

  <h5 class="card_heading"> <img src="../../../assets/job-detail/globe.svg" alt="Image"/> Front-end Developer </h5>
  <div class="mt-3" style="display: flex; margin: auto">
  <p class="card_text"><img src="../../../assets/job-detail/map-pin-light.svg" class="mr-2"/> Abuja , Nigeria</p>
  <p class="card_text" style="margin-left: 40px "><img src="../../../assets/job-detail/dollar-sign-light.svg" class="mr-2"/> 2000 - 6000</p>
...
.vector{
  list-style-image: url('../../../assets/job-detail/Vector.svg');
}
.skill{
  line-height: 44px;
  text-align: center;
...
.vector2{
  list-style-image: url('../../../assets/job-detail/Vector2.svg');
  display: flex;
}
.btn_menu{
  background: #FAFAFC;
