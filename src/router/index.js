...
import tabs from "../components/job-seeker/my-account/tabs";
import ProfileSummery from "../components/job-seeker/my-account/ProfileSummery";
import Experience_and_Skills from "../components/job-seeker/my-account/Experience_and_Skills";
import Education_in_MyAccount from "../components/job-seeker/my-account/Education_in_MyAccount";
import Projects from "../components/job-seeker/my-account/Projects";
import Resume_CV from "../components/job-seeker/my-account/Resume_CV";
import MyApplications from "../components/job-seeker/my-applications/MyApplications";
...
import accounts_detail from "../components/job-seeker/my-account/accounts_detail";
import change_password from "../components/job-seeker/my-account/change_password";
import index_myAccount_2 from "../components/job-seeker/my-account/index_myAccount_2";
import myAccount_4 from "../components/job-seeker/my-account/myAccount_4";
import reports from "../components/job-seeker/my-account/reports";
