      ...
      <div class="flex-child1">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="row py-3">
              <div class="col-md-7">
                <img height="20" src="/static/images/map-pin.png" width="22"/>
      ...
      <div class="flex-child2">
          ...
          <div class="job-status border border-light rounded border_a">
            <div class="row">
              <div class="col-md-2 mt-2">
                <img height="24" src="/static/images/info.png" width="24">
              </div>
        ...
        <div class="row ">
          ...
          <div class="col-md-6 mt-4 mb-4 d-flex d-sm-block justify-content-center">
            <button class="btn border border-primary text-primary float-right" type="button">
              View Similar Jobs
            </button>
          </div>
        </div>
