        ...
        <div class="card-body">
          <div class="row">
            <div class="col-md-2 text-left mt-2 mb-2" >
              <img src="/static/images/google-icon.png" height="80" width="78" />
            </div>
            <div class="col-md-10">
              ...
              <div class="flex-items row">
                <div class="item mr-3">
                  <img src="/static/images/map-pin.svg" alt="map pin" class="mr-1">
                  <span class="text-black-50"> Abuja , Nigeria</span>
                </div>
                <div class="item">
                  <img src="/static/images/clock.svg" alt="map pin" class="mr-1">
                  <span class="text-black-50"> 2 Hours Ago</span>
                </div>
                <div class="item">
                  <img src="/static/images/dollar-sign.svg" alt="map pin" class="mr-1">
          ...
          <div class="text-left">
            ...
            <ul class="text text-left lists" style="line-height: 38px;">
              ...
              <li>End to end project management: Define project tasks, actively track project progress, and milestones,
                publish periodic progress reports, recommend actions</li>
              ...
              <li>Act as a Finance process SME, and suggest process improvements based on experience in applying
                industry best practices at scale</li>
            </ul>
          </div>
          <div>
...
<g mask="url(#mask0)">
            ...
            <template v-else>
              <div >
                <div >
                  <img src="/static/images/upload.png" height="60" width="60"/>
                </div>
              </div>
              <div class="row">
                <div class="col-12">
        ...
        <div class=" mt-4" style="display:flex" >
          <div class="btn_menu text-center"><img class="mr-1" src="/static/images/share.svg" /> Share</div>
          <div class="btn_menu text-center ml-3"><img class="mr-1" src="/static/images/tweeter.svg" /> Tweet</div>
          <div class="btn_menu text-center ml-3"><img class="mr-1" src="/static/images/save.svg" /> Save</div>
        </div>
        <h3 class="description_heading mt-5" style="font-size: 24px">Jobs you might be interested in</h3>

        <div class="card mt-4 p-3">

          <h5 class="card_heading"> <img src="/static/images/globe.svg" alt="Image" /> Front-end Developer </h5>
          <div class="mt-3" style="display: flex; margin: auto">
            <p class="card_text"><img src="/static/images/map-pin-light.svg" class="mr-2" /> Abuja , Nigeria</p>
            <p class="card_text" style="margin-left: 40px "><img src="/static/images/dollar-sign-light.svg" class="mr-2" /> 2000 -
              6000</p>
...
.vector{
  list-style-image: url('/static/images/Vector.svg');
}
.skill-container{
  display: flex;
  flex-direction: row;
...
.vector2{
  list-style-image: url('/static/images/Vector2.svg');
  display: flex;
}
.btn_menu{
  background: #FAFAFC;
